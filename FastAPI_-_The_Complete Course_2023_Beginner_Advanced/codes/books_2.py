...
class Book(BaseModel):
    ...
    class Config:
        schema_extra = {
            "example": {
                "id": "1b31e46c-5949-4e34-b3cd-b6930be442d5",
...
async def negative_number_exception_handler(request: Request,
    ...
    return JSONResponse(
        status_code=418,
        content={"message": f"Hey, why do you wnat {exception.books_to_return} "
...
def create_books_no_api():
    book_1 = Book(
        id="eb31e46c-5949-4e34-b3cd-b6930be442d5",
        title="Title 1",
        author="Author 1",
    ...
    book_2 = Book(
        id="2b31e46c-5949-4e34-b3cd-b6930be442d5",
        title="Title 2",
        author="Author 2",
    ...
    book_3 = Book(
        id="3b31e46c-5949-4e34-b3cd-b6930be442d5",
        title="Title 3",
        author="Author 3",
    ...
    book_4 = Book(
        id="4b31e46c-5949-4e34-b3cd-b6930be442d5",
        title="Title 4",
        author="Author 4",
